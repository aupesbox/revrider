...
class _ExhaustStudioState extends State<ExhaustStudio> {
  ...
  double crossfade = 1.0, pitchSens = 1.0, volume = 1.0, previewThrottle = 0.0;
    ...
    return AppScaffold(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          // Crossfade
          Text('Crossfade: ${crossfade.toStringAsFixed(2)}'),
          Slider(
            value: crossfade,
            min: 0.1,
            max: 2.0,
          ...
          // Pitch
          Text('Pitch Sens: ${pitchSens.toStringAsFixed(2)}'),
          Slider(
            value: pitchSens,
            min: 0.1,
            max: 3.0,
